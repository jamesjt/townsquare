...
await page.evaluate(() => {
  ...
  store.commit("session/setSessionId", "ft1054wide");
});
...
await page.screenshot({
  path: "claude_temp_test/2026-08-22-ft1054-shots/06-wide-viewport-full.png",
});
await page.screenshot({
  path: "claude_temp_test/2026-08-22-ft1054-shots/07-wide-row-crop.png",
  clip: { x: Math.max(0, box.x - 20), y: box.y - 15, width: box.width + 40, height: box.height + 30 },
});
await browser.close();
